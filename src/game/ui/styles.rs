...
pub const BACKGROUND_COLOUR: BackgroundColor = {
    let background_colour = Color::srgba(0.25, 0.25, 0.25, 0.5);
...
pub const LHS_NODE_STYLE: Node = {
    let mut node = Node::DEFAULT;
    node.flex_direction = FlexDirection::Row;
    node.justify_content = JustifyContent::Center;
    node.align_items = AlignItems::Center;
    node.width = Val::Px(200.0);
    node.height = Val::Percent(80.0);
    node.margin = UiRect::new(Val::Px(32.0), Val::Px(0.0), Val::Px(16.0), Val::Px(0.0));
    node
};

pub const RHS_NODE_STYLE: Node = {
    let mut node = Node::DEFAULT;
    node.flex_direction = FlexDirection::Row;
    node.justify_content = JustifyContent::Center;
    node.align_items = AlignItems::Center;
    node.width = Val::Px(200.0);
    node.height = Val::Percent(80.0);
    node.margin = UiRect::new(Val::Px(0.0), Val::Px(32.0), Val::Px(16.0), Val::Px(0.0));
    node
};
