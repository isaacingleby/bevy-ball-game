...
pub const COLOUR_NORMAL: Color = Color::srgb(0.15, 0.15, 0.15);
...
// pub const COLOUR_RED: Color = Color::srgb(1.0, 0.0, 0.0);

pub const MAIN_MENU_NODE_STYLE: Node = {
...
pub const IMAGE_NODE_STYLE: Node = {
    let mut node = Node::DEFAULT;
